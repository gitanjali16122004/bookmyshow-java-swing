...
import static bookmyshow.BookMyShow_fram.total_seat_price;
...
public class SeatConfirmation extends javax.swing.JFrame {
    ...
    public SeatConfirmation() {
        ...
        seat_price = (BookMyShow_fram.seat_price); 
        seat_count = (BookMyShow_fram.seat_count);
        amount_str = (BookMyShow_fram.amount_str ); 
        total_seat_price = (BookMyShow_fram.total_seat_price);
        food_name = (BookMyShow_fram.food_name );
        food_amt = (BookMyShow_fram.food_amt);
        seatType_str = (BookMyShow_fram.seatType_str); 
        foodCount_str = (BookMyShow_fram.foodCount_str); 
        selectSeatCombo = (BookMyShow_fram.selectSeatCombo); 
        numOfSeatcCombo = (BookMyShow_fram.numOfSeatcCombo);
        foodCombo = (BookMyShow_fram.foodCombo); 
        foodQuantityCombo = (BookMyShow_fram.foodQuantityCombo);
    ...
    void setMovie()
    {
        ...
        if(BookMyShow_fram.movie_number == 1)
        {
        ...
        else if(BookMyShow_fram.movie_number == 2)
        {
        ...
        else if(BookMyShow_fram.movie_number == 3)
        {
        ...
        else if(BookMyShow_fram.movie_number == 4)
        {
    ...
    private void back_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_back_btnActionPerformed
        ...
        BookMyShow_fram.frame.setVisible(true);
        dispose();
